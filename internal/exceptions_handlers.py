...
async def user_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def user_email_confirm_exception_handler(request: Request, exc: Exception) -> Response:
...
async def user_checker_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def user_checker_not_match_exception_handler(request: Request, exc: Exception) -> Response:
...
async def user_email_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def jwt_refresh_token_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def email_verified_exception_handler(request: Request, exc: Exception) -> Response:
...
async def user_password_not_match_exception_handler(request: Request, exc: Exception) -> Response:
...
async def workout_last_id_not_match_exception_handler(request: Request, exc: Exception) -> Response:
...
async def workout_last_owner_not_match_exception_handler(request: Request, exc: Exception) -> Response:
...
async def bike_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def last_workout_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
...
async def agency_not_exist_exception_handler(request: Request, exc: Exception) -> Response:
